...
for (i in 1:length(files)) {
  ...
  dpath <- paste(dbox_path, files[i], sep = "")
  ...
  pd <- read_csv(file = "C:/Users/james/Dropbox/IMBRSea_2021/Results/PlateReader/Exp2_plate_design.csv")
...
write_csv(pl_data.p, 
          file = here("Data/plate_reader_Exp2.csv"))
